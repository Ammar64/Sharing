...
public class ScreenFragment extends Fragment {
    public static final String ARG_MEDIA_PERMISSION_DATA = "ARG_MEDIA_PERMISSION_DATA";
    User mUser;
    ...
    private void initWebRTC(SurfaceViewRenderer localVideoView) {
        ...
        mVideoCapturer = createScreenCapture();
...
//        }, sdpConstraints);
    ...
    private VideoCapturer createScreenCapture() {
        return new ScreenCapturerAndroid(
                requireArguments().getParcelable(ARG_MEDIA_PERMISSION_DATA), new MediaProjection.Callback() {
            @Override
            public void onStop() {
            }
        });
