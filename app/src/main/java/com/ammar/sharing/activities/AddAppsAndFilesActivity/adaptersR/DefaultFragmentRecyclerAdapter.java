...
public class DefaultFragmentRecyclerAdapter extends RecyclerView.Adapter<FilesBrowseOptionViewHolder> {
    ...
    public DefaultFragmentRecyclerAdapter(DefaultFragment fragment, AddAppsAndFilesActivity activity) {
