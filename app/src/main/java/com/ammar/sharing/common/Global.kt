...
object Global {
    const val TAG = "SHARE-ANY-TAG"

    // These values are initialized in AppShareAny
    @JvmField
    var IS_FIRST_RUN: Boolean = false;
    @JvmField
    var IS_FIRST_RUN_AFTER_UPDATE: Boolean = false

    lateinit var WEB_ASSETS_PATH: File
