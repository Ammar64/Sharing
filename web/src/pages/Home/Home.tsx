        ...
        <Container>
            <Grid container spacing={3}>
                <Grid size={{ xs: 12, md: 6 }}>
                    <SharingMainActionCard cardProps={{ disabled: disableUpload, action_string_key: "upload", bgcolor: "cyan", onClick: () => uploadProgressDialogRef.current?.setDialogOpen(true), disabledTooltipKey: "uploading_is_disabled" }} />
                </Grid>
                <Grid size={{ xs: 12, md: 6 }}>
