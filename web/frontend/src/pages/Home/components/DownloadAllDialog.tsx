...
function DownloadAllDialog(_: unknown, ref: Ref<DownloadAllDialogRef>) {
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                <Stack direction="row" dir="ltr" sx={{ alignItems: "center" }}>
                    <TextField /* TODO: Check how RTL layout behaves */
                        ...
                        sx={{ marginTop: 1 }}
                    />
                    <Typography sx={{ marginLeft: 1, fontSize: 16, paddingTop: 1 }}>.zip</Typography>
                </Stack>
                <Typography sx={{
                    color: "textSecondary",
                    fontSize: 14,
                    maxWidth: 300
                }}>{t("all_files_download_info")}</Typography>
            </DialogContent>
            <DialogActions>
