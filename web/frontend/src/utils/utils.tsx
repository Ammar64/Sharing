...
export function createNewShareAnyAppTheme(uiMode: "dark" | "light", dir: "rtl" | "ltr"): Theme {
...
export function createShareAnyAppDarkTheme() {
    return createNewShareAnyAppTheme("dark", document.documentElement.dir as any);
}
